...
public class Duration implements Comparable<Duration> {
    ...
    /**
     * Create a Duration object that represents the given quantity of the given time
     * unit.
     * 
     * For example, the expression <em>new Duration("minutes", 4)</em> creates a
     * Duration object that represents 4 minutes.
     * 
    ...
    /**
     * Create a Duration object that represents the same length of time as that
     * given.
     */
    ...
    /**
     * Obtain an integer value that represents that part of this Duration which may
     * be expressed as a multiple of the given time unit.
     * 
     * For example, given a duration object d that represents 4 minutes and 30
     * seconds, d.intValue("minute") produces the value 4.
     * 
     * Permissible time units are: "millisecond", "second", "minute", "hour", "day".
     */
    ...
    /**
     * Obtain a double value that represents this Duration expressed as a multiple
     * of the given time unit.
     * 
     * For example, given a duration object d that represents 4 minutes and 30
     * seconds, d.doubleValue("minute") produces the value 4.5.
     * 
     */
    ...
    /**
     * Obtain the result of multiplying this Duration by the given value. The result
    ...
    /**
     * Obtain the result of dividing this Duration by the given value. The result is
    ...
    /**
     * Obtain the remainder of an integer division of this Duration by the given
     * Duration.
     */
    ...
    /**
     * Return a negative, zero, or positive value, depending on whether this
     * duration is smaller, equal to, or greater than the given duration.
     */
     ...
     * 
     * Object o is equivalent if it is a Duration of the same value as this
     * Duration.
     * 
     */
    ...
    /**
     * Returns a representation of this Duration as quantities of the given series
     * of units. Given a unit at units[i], units[i+1] must be a sub unit.
     * 
     * Example {em>(new Duration("second", 93873)).split("hour", "minute",
     * "second")</em> returns an array containing the values 26, 4, 33 i.e. 26 hours
     * with remainder of 44 minutes with remainder of 33 seconds.
     */
     ...
     * of units. Given a unit at units[i], units[i+1] must be a sub unit.
     * 
     * Example <em>(new Duration(TimeUnit.SECOND, 93873)).split(TimeUnit.HOUR,
     * TimeUnit.MINUTE, TimeUnit.SECOND)</em> returns an array containing the values
     * 26, 4, 33 i.e. 26 hours with remainder of 44 minutes with remainder of 33
     * seconds.
     */
    ...
    /**
     * Obtain a formatted string that expresses the given duration as a series of
     * non-zero time unit quantities from the largest applicable to the given
     * smallest.
     * 
     * Example: Given <em>Duration d=new Duration("second", 88893); )</em>, the
     * expression <em>Duration(d, "second")</em> returns the string "1 day 41
     * minutes 33 seconds", while <em>Duration(d, "minute")</em> returns the string
     * "1 day 41 minutes".
     * 
     */
     ...
     * smallest.
     * 
     * Example: Given <em>Duration d=new Duration(TimeUnit.SECOND, 88893); )</em>,
     * the expression <em>Duration(d, TimeUnit.SECOND)</em> returns the string "1
     * day 41 minutes 33 seconds", while <em>Duration(d, TimeUnit.MINUTE)</em>
     * returns the string "1 day 41 minutes".
     * 
     */
    ...
    /**
     * Obtain a formatted string that expresses the given duration as a series of
     * no-zero quantities of the given time units.
     * 
     * Example: Given <em>Duration d=new Duration("second", 88893); )</em>, the
     * expression <em>Duration(d, "hour", "minute", "second")</em> returns the
     * string "24 hours 41 minutes 33 seconds", while <em>Duration(d, "hour",
     * "second")</em> returns the string "24 hours 2493 seconds".
     */
     ...
     * 
     * Example: Given <em>Duration d=new Duration(TimeUnit.SECOND, 88893); )</em>,
     * the expression <em>Duration(d, TimeUnit.HOUR, TimeUnit.MINUTE,
     * TimeUnit.SECOND)</em> returns the string "24 hours 41 minutes 33 seconds",
     * while <em>Duration(d, TimeUnit.HOUR, TimeUnit.SECOND)</em> returns the string
     * "24 hours 2493 seconds".
     */
