...
/**
 * A Time object represents a twenty four hour clock reading composed of hours,
 * minutes and seconds.
 * 
 * 
...
public class Time implements Comparable<Time> {
     ...
     * 
     * The given value is mapped onto the twenty four hour clock. So for example, a
     * duration of 7 hours, 5 minutes produces a Time object representing the value
     * 07:05.
     * 
     * If the given value exceeds a twenty four hour period then it is "wrapped
     * around". So for example, a duration of 25.5 hours produces a Time object
     * representing the value 01:30.
     * 
    ...
    /**
     * Create a Time object representing the given time in hours, minutes and
     * seconds.
     */
    ...
    /**
     * Obtain the Time that results from subtracting the given period from this
     * Time.
     */
    ...
    /**
     * Obtain the period between this time and the given time by subtracting the
    ...
    /**
     * Returns true if the given object is a Time object and represents the same
     * time value as this Time object, otherwise returns false.
     */
    ...
    /**
     * Compare this Time object with the other Time object, returning -1, 0 or 1,
     * depending on whether this Time precedes, is equal to, or exceeds the other
     * time value.
     * 
     */
    ...
    public static boolean isValid(String string) {
        return string.matches("\\d:[0-5]\\d") || string.matches("[01]\\d:[0-5]\\d")
                || string.matches("2[0-3]:[0-5]\\d");
    }
}
