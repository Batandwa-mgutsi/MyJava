...
//        Monitor.log(String.format("Money(String, Currency):%h\n", super.hashCode()));
    }
   ...
   //     Monitor.log(String.format("Money:add():%h\n", super.hashCode()));
    ...
    /**
     * <p>Multiply this monetary amount by the given value.</p>
     * 
     * <p>The result is rounded to the nearest minor currency unit e.g. to the nearest penny in 
     * the case of the British pound.</p>
     * 
     * <p>The Money objects must be of the same currency.</p>
     * 
     * @return a Money object that represents this monetary amount multiplied by the given 
     * value and rounded to the nearest minor currency unit.
     * 
     */
    public Money multiply(double value) {
        return new Money(Math.round(this.longAmount()*value), this.currency());
    }
    
    /**
     * <p>Divide this monetary amount by the given value.</p>
     * 
     * <p>The result is rounded to the nearest minor currency unit e.g. to the nearest penny in 
     * the case of the British pound.</p>
     * 
     * <p>The Money objects must be of the same currency.</p>
     * 
     * @return a Money object that represents this monetary amount divided by the given 
     * value and rounded to the nearest minor currency unit.
     * 
     */
...
//        Monitor.log(String.format("Money:toString():%h\n", super.hashCode()));
